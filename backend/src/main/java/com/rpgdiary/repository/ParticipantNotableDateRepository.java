...
@Repository
public interface ParticipantNotableDateRepository
        extends JpaRepository<ParticipantNotableDate, Long>, QuerydslPredicateExecutor<ParticipantNotableDate> {
    ...
    List<ParticipantNotableDate> findByParticipantAndCalendarType(Participant participant, CalendarType calendarType);
    ...
    List<ParticipantNotableDate> findByCalendarTypeAndYearIsNullAndIsRecurringTrue(CalendarType calendarType);

    @Query("SELECT pnd FROM ParticipantNotableDate pnd " + "WHERE pnd.calendarType = :calendarType "
