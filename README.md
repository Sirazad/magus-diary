# RPG Diary App
(The front end is purely AI generated!! It probably contains a lot of suboptimal, non business standard, insecure solutions, it simply serves the purpose of giving a platform where my backend can be used.)
